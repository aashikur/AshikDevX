...
export default function AboutMeSection() {
    return <div id='aboutMeSection' className="scroll-mt-navbar hero-card border-none rounded-xl p-8 md:p-12 shadow-sm border transition-transform duration-300 ease-[cubic-bezier(0.34,1.56,0.64,1)] hover:-translate-y-1 hover:shadow-xl max-w-[1400px] mx-auto">
        <div className="flex flex-col md:flex-row gap-12">
            ...
            <div className="md:w-2/3">
                ...
                <p className="text-gray-600 dark:text-gray-300 mb-8 max-w-2xl leading-relaxed">
                   Hi, I’m Ashik — a Full-Stack Web Developer who helps businesses and entrepreneurs turn complex ideas into seamless digital experiences. <br/> <br/>
              ...
              <Button href="#" className="btn btn-dark inline-block px-5 py-2.5  text-sm dark:hover:bg-slate-200">View Projects</Button>
              <Button variant="outline" href="#" className="btn btn-light  px-5 py-2.5 text-sm">
                ...
                <div className="flex items-center gap-4">
                    ...
                    <div className="flex gap-3">
                        <a href="https://github.com/aashikur" className="social-link w-8 h-8 rounded-full flex items-center justify-center text-gray-600 dark:text-gray-300 hover:text-gray-900 dark:hover:text-white transition-transform hover:-translate-y-0.5 hover:bg-slate-100 dark:hover:bg-slate-800">
                            <GithubIcon />
                        </a>
                        <a href="https://www.linkedin.com/in/mdaashikur/" className="social-link w-8 h-8 rounded-full flex items-center justify-center text-gray-600 dark:text-gray-300 hover:text-gray-900 dark:hover:text-white transition-transform hover:-translate-y-0.5 hover:bg-slate-100 dark:hover:bg-slate-800">
                            <LinkedinIcon />
                        </a>
                        <a href="https://x.com/" className="social-link w-8 h-8 rounded-full flex items-center justify-center text-gray-600 dark:text-gray-300 hover:text-gray-900 dark:hover:text-white transition-transform hover:-translate-y-0.5 hover:bg-slate-100 dark:hover:bg-slate-800">
                            <TwitterIcon />
                        </a>
                    </div>
                </div>
